...
# ________________0______1______2__3______4______5_____6__7__8_____9______10_11____12_____13___14____15
list_of_params = [0.002, 0.002, 17, 0.000005, 0.1, 'map', 0, 0, True, False, 0, 0, False, '', False, '']
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(10, 310, 501, 20))
        self.lineEdit_2.setAcceptDrops(True)
        self.lineEdit_2.setClearButtonEnabled(True)
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.pushButton_9 = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton_9.setGeometry(QtCore.QRect(520, 310, 51, 23))
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle(_translate("MainWindow", "Большая задача по Maps API. Часть №9"))
        ...
        self.pushButton_9.setText(_translate("MainWindow", "on/off"))
    ...
    def getImage(self, arg):
        ...
        if arg == 1:
            ...
            if response:
                ...
                list_of_params[15] = post
                if list_of_params[14]:
                    self.lineEdit_2.setText(f'{list_of_params[13]}, Почтовый индекс: {str(post)}')
                else:
            ...
            if list_of_params[14]:
                list_of_params[14] = False
                self.lineEdit_2.setText(list_of_params[13])
            else:
                list_of_params[14] = True
                self.lineEdit_2.setText(f'{list_of_params[13]}, Почтовый индекс: {list_of_params[15]}')
